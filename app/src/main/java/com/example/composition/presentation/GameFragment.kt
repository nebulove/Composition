...
class GameFragment : Fragment() {
    ...
    private fun observeViewModel() {
        ...
        viewModel.percentOfRight.observe(viewLifecycleOwner) {
            binding.progressBar.setProgress(it, true)
        }
        viewModel.enoughCountOfRight.observe(viewLifecycleOwner) {
            binding.tvAnswersProgress.setTextColor(getColorByState(it))
        }
        viewModel.enoughPercentOfRight.observe(viewLifecycleOwner) {
